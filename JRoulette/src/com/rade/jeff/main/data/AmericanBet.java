...
public class AmericanBet extends LocaleBet implements Bet, Serializable{
	
	private static final long serialVersionUID = 1290385728982348923L;

	public enum AmericanTypeOfBet{
		BLACK,
		RED,
		GREEN,
		ODDS,
		...
		ZERO_1_2_BASKET, //AMERICAN TABLE
		ZERO_00_2_BASKET, //AMERICAN TABLE
		DOUBLE_ZERO_2_3_BASKET, //AMERICAN TABLE
		TOPLINE, //AMERICAN TABLE
	}
	...
	private static final Set<Integer> DOUBLE_ZERO = new HashSet<Integer>(); //American Wheels
	private static final Set<Integer> BOTH_ZEROS = new HashSet<Integer>(); //American Wheels
	...
	private static final Set<Integer> TWENTY_EIGHT_29_31_32_CORNER = new HashSet<Integer>();
	...
	private static final Set<Integer> ZERO_00_2_BASKET = new HashSet<Integer>();
	private static final Set<Integer> DOUBLE_ZERO_2_3_BASKET = new HashSet<Integer>();
	private static final Set<Integer> TOPLINE = new HashSet<Integer>();
	
	static{
		ZERO.add(NZERO);
		DOUBLE_ZERO.add(NTHIRTY_SEVEN);
		...
		GREEN_NUMBERS.add(DOUBLE_ZERO.iterator().next()); //American Wheels
		
		BOTH_ZEROS.add(ZERO.iterator().next());
		BOTH_ZEROS.add(DOUBLE_ZERO.iterator().next()); //Amercian Wheels
		...
		TWENTY_EIGHT_29_31_32_CORNER.add(NTWENTY_EIGHT); TWENTY_EIGHT_29_31_32_CORNER.add(NTWENTY_NINE); TWENTY_EIGHT_29_31_32_CORNER.add(NTHIRTY_ONE); TWENTY_EIGHT_29_31_32_CORNER.add(NTHIRTY_TWO); 
		...
		ZERO_00_2_BASKET.add(NZERO); ZERO_00_2_BASKET.add(Integer.valueOf(DOUBLE_ZERO.iterator().next())); ZERO_00_2_BASKET.add(NTWO); 
		DOUBLE_ZERO_2_3_BASKET.add(Integer.valueOf(DOUBLE_ZERO.iterator().next())); DOUBLE_ZERO_2_3_BASKET.add(NTWO); DOUBLE_ZERO_2_3_BASKET.add(NTHREE); 

		TOPLINE.add(NZERO);
		TOPLINE.add(Integer.valueOf(DOUBLE_ZERO.iterator().next()));
		TOPLINE.add(NONE);
		TOPLINE.add(NTWO);
		TOPLINE.add(NTHREE);
	...
	public String[] getBetChoices(){
		AmericanTypeOfBet[] values = AmericanTypeOfBet.values();
	...
	public AmericanBet(final String betName, final Money amount){
		this();
	...
	private Set<Integer> determineBet(String betName){
		Set<Integer> theBet = null;
		AmericanTypeOfBet betEnum = AmericanTypeOfBet.valueOf(betName.toUpperCase());
		switch(betEnum){
			...
			case DOUBLE_ZERO: theBet = DOUBLE_ZERO; break;
			case BOTH_ZEROS: theBet = BOTH_ZEROS; break;
			//case GREEN: theBet = BOTH_ZEROS; break;
			...
			case TWENTY_EIGHT_29_31_32_CORNER: theBet = TWENTY_EIGHT_29_31_32_CORNER; break;
			...
			case ZERO_1_2_BASKET: theBet = ZERO_1_2_BASKET; break;
			case ZERO_00_2_BASKET: theBet = ZERO_00_2_BASKET; break;
			case DOUBLE_ZERO_2_3_BASKET: theBet = DOUBLE_ZERO_2_3_BASKET; break;
			case TOPLINE: theBet = TOPLINE; break;
			default: theBet = null;
		}
	...
	static{
		AmericanTypeOfBet[] localArray = AmericanTypeOfBet.values();
		stringArrayOfBets = new String[AmericanTypeOfBet.values().length];
		int i = 0;
	...
	public boolean isValidBet(String betName) {
		return super.isValidBet(betName, stringArrayOfBets); //TODO is stringArrayOfBets thread-safe?
	}

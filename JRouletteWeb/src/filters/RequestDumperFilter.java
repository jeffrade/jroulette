...
public final class RequestDumperFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
    	System.out.println("### Entering RequestDumperFilter.doFilter ###");
        if (filterConfig == null){
        	System.out.println("### Exiting RequestDumperFilter.doFilter ###");
        	return;
        }
		...
		if (request instanceof HttpServletRequest) {
		    ...
		    writer.println("     userPrincName=" + hrequest.getUserPrincipal().getName());
		    writer.println("   userPrincString=" + hrequest.getUserPrincipal().toString());
		}
		writer.println("=============================================");
		...
		System.out.println(sw.getBuffer().toString()); //Added by JER
